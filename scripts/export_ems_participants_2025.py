"""Extrait les participations approuvées des compétitions EMS françaises 2025."""
...
INPUT_FILE = ROOT / (
    "data/processed/"
    "ems_competitions_france_waterski_2025_avec_urls.csv"
)

OUTPUT_FILE = ROOT / (
    "data/processed/"
    "ems_participations_france_waterski_2025.csv"
)

FAILURES_FILE = ROOT / (
    "data/processed/"
    "ems_participations_france_waterski_2025_echecs.csv"
)
...
def read_calendar() -> list[dict[str, str]]:
    """Lit le registre 2025 avec les URL EMS."""
...
def main() -> None:
    ...
    print("=" * 80)
    print("EXTRACTION EMS — PARTICIPATIONS APPROUVÉES 2025")
    print("=" * 80)
