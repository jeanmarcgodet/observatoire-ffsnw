"""Extrait les participations approuvées des compétitions EMS françaises 2026."""
...
INPUT_FILE = ROOT / (
    "data/processed/"
    "ems_competitions_france_waterski_2026_avec_urls.csv"
)
...
FAILURES_FILE = ROOT / (
    "data/processed/"
    "ems_participations_france_waterski_2026_echecs.csv"
)
...
def read_calendar() -> list[dict[str, str]]:
    """Lit le registre 2026 avec les URL EMS."""
...
def main() -> None:
    ...
    print("=" * 80)
    print("EXTRACTION EMS — PARTICIPATIONS APPROUVÉES 2026")
    print("=" * 80)
