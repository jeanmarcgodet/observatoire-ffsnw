"""Extrait les participations approuvées des compétitions EMS françaises 2021."""
...
INPUT_FILE = ROOT / (
    "data/processed/"
    "ems_competitions_france_waterski_2021_avec_urls.csv"
)

OUTPUT_FILE = ROOT / (
    "data/processed/"
    "ems_participations_france_waterski_2021.csv"
)

FAILURES_FILE = ROOT / (
    "data/processed/"
    "ems_participations_france_waterski_2021_echecs.csv"
)
...
def read_calendar() -> list[dict[str, str]]:
    """Lit le registre 2021 avec les URL EMS."""
...
def main() -> None:
    ...
    print("=" * 80)
    print("EXTRACTION EMS — PARTICIPATIONS APPROUVÉES 2021")
    print("=" * 80)
